...
4. Start the server:
   ...
   uv run python -m xkcd_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn xkcd_mcp.server:app --port 10778
   ```
5. Open `http://localhost:10778` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/xkcd-mcp/issues) |
