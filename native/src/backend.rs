...
const BACKEND_NAME: &str = "xkcd-mcp-backend.exe";
const BACKEND_PORT: u16 = 10778;
const BACKEND_TAG: &str = "xkcd-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "XKCD_MCP_PORT";
const ENV_HOST: &str = "XKCD_MCP_HOST";
const ENV_TAURI: &str = "XKCD_MCP_TAURI";
